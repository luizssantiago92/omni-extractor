...
Brand polish plus real List Extractor logic
...
- Demand stated: Brand polish plus real List Extractor logic
...
- **Free:** local extraction, local datasets, table UI, local download/export (CSV / Excel / JSON / images / text, etc.).
- **Paid later:** cloud save / cloud dataset workspace (details TBD); billable **AI agents / AI credits**.
- Proposed WHAT: Responsive green/gold Omni UI with O+6-arms icon; content-script list picker and extraction; Auto-Scroll/Pagination/Load More; local datasets + minimal Data table; completion screen. Out of scope: settings/notifications chrome, Cloud backend, Text/Image/Maps tools.
- DONE criterion: Icon and palette updated; side panel adapts to narrow/wide panel; user can select a real list, run extraction with chosen load-more mode, see progress/completion, and view/export CSV from local Data table
