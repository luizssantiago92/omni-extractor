...
Rebrand away from green; tip banner; notify+settings; optional account
...
- Demand stated: Rebrand away from green; tip banner; notify+settings; optional account
...
- **Free:** local extraction, local datasets, table UI, local download/export (CSV / Excel / JSON / images / text, etc.).
- **Paid later:** cloud save / cloud dataset workspace (details TBD); billable **AI agents / AI credits**.
- Proposed WHAT: Steel/gold palette, new mark, tip slides, notify+settings UI shells
- DONE criterion: New palette visible; tips rotate 5s; notify list opens; settings placeholder; no forced login
